...
class TwilioSmsExceptions extends Exception
{
    /**
     * According to TwilioSms Documentation Following Codes and Messages are Exceptions
     */
    const EXCEPTIONS = [
        1   => "Username is wrong",
        2   => "Password is wrong",
     ...
     * @return null
     * @throws \MixCode\Utils\Exceptions\TwilioSmsExceptions
     */
