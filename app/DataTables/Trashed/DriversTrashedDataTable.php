...
class DriversTrashedDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ...
            ->addColumn('restore', 'dashboard.drivers.buttons.restore')
            ->addColumn('delete', 'dashboard.drivers.buttons.force_delete')
    ...
    {
        return $model->newQuery()->where('type',User::DRIVER_TYPE)->onlyTrashed()->select('*');
    }
    ...
    {
        return 'Trashed_User_' . date('YmdHis');
    }
}
