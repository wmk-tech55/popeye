...
@section('content')
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div>
        ...
        <a href="{{ route('dashboard.discounts.trashed') }}" class="d-sm-inline-block btn btn-sm btn-danger shadow-sm">
            <i class="fas fa-trash fa-sm text-white-50"></i>
            @lang('main.trashed') @lang('main.discounts')
        </a>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('dashboard.discounts.destroyGroup') }}">
                            @csrf
                            @method('DELETE')
                            
                            {!! $dataTable->table(['class'=> 'table table-sdiscounted table-bordered table-hover'], true) !!}
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.createBtn', function() {
            window.location = "{{ route('dashboard.discounts.create') }}";
        });
