...
<div class="form-group mb-4 row">
    ...
    <div class="col-sm-10">
        <input type="number" min="1"  name="discount" value="{{ old('discount') }}" id="discount" class="form-control @error('discount') is-invalid @enderror" placeholder="@lang('main.discount')" required>
        @error('discount')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
