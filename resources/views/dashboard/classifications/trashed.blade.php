...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <a href="{{ route('dashboard.classifications.create') }}" class="d-sm-inline-block btn btn-sm btn-success shadow-sm">
        ...
        <div class="col-xl-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    <form method="post" action="{{ route('dashboard.classifications.forceDestroyGroup') }}">
                        @csrf
                        @method('DELETE')
