...
{{-- <div class="form-group my-4 row">
    ...
    <div class="col-sm-10">
        <input type="text" name="username" value="{{ old('username') }}" id="username" class="form-control @error('username') is-invalid @enderror" placeholder="@lang('main.username')" required>
        @error('username')
...
<input type="hidden" value="{{auth()->user()->active_country_id}}" id="country_id" name="country_id" />
...
{{-- Logo --}}
{{-- <div class="form-group mb-4 row">
    <label class="col-sm-2 col-form-label" for="logo">
        @lang('main.logo')
    </label>
    <div class="col-sm-10">
