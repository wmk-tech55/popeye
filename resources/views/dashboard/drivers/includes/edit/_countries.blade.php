...
<div class="form-group mb-4 row">
    ...
    <div class="col-sm-10">
        <select name="country_data_id" id="country_id" class="form-control select2 @error('country_id') is-invalid @enderror"
             required>
            <option value="" disabled selected>@lang('main.country')</option>
            @foreach ($countries as $country)
                <option value="{{ $country->id }}"
                    {{ old('country_id', $driver->active_country_id) == $country->id ? 'selected' : '' }}>
