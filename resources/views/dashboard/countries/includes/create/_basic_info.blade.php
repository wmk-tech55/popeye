  ...
  <div class="form-group my-4 row">
      ...
      <div class="col-sm-10">
          <input type="text" name="en_name" value="{{ old('en_name') }}" id="en_name"
              class="form-control @error('en_name') is-invalid @enderror" placeholder="@lang('main.en_name')" required>
          @error('en_name')
  ...
  <div class="form-group mb-4 row">
      ...
      <div class="col-sm-10">
          <input type="text" name="ar_name" value="{{ old('ar_name') }}" id="ar_name"
              class="form-control @error('ar_name') is-invalid @enderror" placeholder="@lang('main.ar_name')" required>
          @error('ar_name')
              <div class="invalid-feedback">
                  {{ $message }}
              </div>
  ...
  <div class="form-group mb-4 row">
      ...
      <div class="col-sm-10">
          <input type="text" name="en_currency" value="{{ old('en_currency') }}" id="en_currency"
  ...
  <div class="form-group mb-4 row">
      ...
      <div class="col-sm-10">
          <input type="text" name="ar_currency" value="{{ old('ar_currency') }}" id="ar_currency"
  ...
  {{--  country_code --}}
  <div class="form-group mb-4 row">
      <label class="col-sm-2 col-form-label" for="country_code">@lang('main.country_code')<span class="required"></span> </label>
      <div class="col-sm-10">
          <input type="text" name="country_code" value="{{ old('country_code') }}" id="country_code"
              class="form-control @error('country_code') is-invalid @enderror" placeholder="@lang('main.country_code_iso_example')" required>
          @error('country_code')
              <div class="invalid-feedback">
                  {{ $message }}
              </div>
