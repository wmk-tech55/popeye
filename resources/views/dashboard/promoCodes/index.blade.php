    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('dashboard.promoCodes.destroyGroup') }}">
                            @csrf
                            @method('DELETE')
                            
                            {!! $dataTable->table(['class'=> 'table table-spromoCodeed table-bordered table-hover'], true) !!}
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.createBtn', function() {
            window.location = "{{ route('dashboard.promoCodes.create') }}";
        });
