<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover text-center">
        ...
        <tbody>
            @foreach ($service->work_times as $work_time)
                <tr>
                ...
                @push('before_scripts')
                    @component('dashboard.components.editModelForm') 
                        ...
                        @slot('url', route('dashboard.services.update.work_time', ['service' => $service, 'work_time' => $work_time]) ) 
                        
                        @include('dashboard.services.includes._work_time_edit_form')
                    @endcomponent
                @endpush
