...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <a href="{{ route('dashboard.companies.trashed') }}" class="d-sm-inline-block btn btn-sm btn-danger shadow-sm">
                <i class="fas fa-trash fa-sm text-white-50"></i>
                @lang('main.trashed') @lang('main.companies')
            </a>
    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 col-sm-12">
            <div class="card">
                @include('dashboard.companies.includes._filter_with_categorization_form', [
                ...
                <div class="card-body table-responsive">
                    <form method="post" action="{{ route('dashboard.companies.destroyGroup') }}">
                        @csrf
                        @method('DELETE')
...
@section('scripts')
    ...
    <script>
        $('#categorization').on('change', function() {
            ...
            window.location = "{{ route('dashboard.companies.index') }}" + '?categorizations=' + categorizations;
        });

        $('#filter_clear').on('click', function() {
            window.location = "{{ route('dashboard.companies.index') }}";
        });
    </script>
