...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('dashboard.companies.index') }}" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            <i class="fas fa-companies fa-sm text-white-50"></i>
        ...
        <div class="col-xl-12 col-md-12 col-sm-12">
            <form action="{{ route('dashboard.companies.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body border-left-danger">
                    ...
                    <div class="card-text">
                        @include('dashboard.companies.includes.create._social_info')
                    </div>
                </div>
            </div> --}}
                ...
                <div class="card">
                    <div class="card-body border-left-info">
                        <div class="form-group row">
                            <div class="col-sm-10">
                                <button type="submit" class="btn btn-info">@lang('main.add') @lang('main.company')</button>
                            </div>
                        </div>
                    </div>
                </div>
