 ...
 @endif
 {{-- address --}}
 @if ($company->userCountry)
     <div class="col-md-12 col-sm-12">
         <div class="h6">
             <span class="font-weight-bold">@lang('main.country'): </span>

             <span class="text-muted">{{ $company->userCountry->name_by_lang ?? trans('main.not_found') }}</span>
 ...
 @if ($company->isCompany())
     <div class="col-md-6 col-sm-12">
         <div class="h6">
             ...
             <span class="text-muted">{{ $company->categorization->name_by_lang ?? null}}</span>
         </div>
         <hr>
     </div>
 @endif
