...
<form class="form-group mb-4 row m-2" method="GET" action="{{ route('dashboard.companies.index') }}">
    ...
    <div class="col-sm-3 m-1  ">
        ...
        @if (count($categorizations_id) > 0)
            <a href="{{ route('dashboard.companies.index') }}" class="btn btn-info ml-1 mr-1"
