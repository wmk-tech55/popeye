                        ...
                        <div class="card-body mt-5 px-3 py-0">
                            <form id="create-form" action="{{ route('dashboard.products.store') }}" method="POST"
                                ...
                                <div id="basic-info" class="content fade" role="tabpanel"
                                    ...
                                    <hr>
                                    @include('dashboard.products.includes.create._categories_info')
                                    <hr>
                                ...
                                <div id="prices-and-classifications-info" class="content fade" role="tabpanel"
                                    ...
                                    {{--                   @include('dashboard.products.includes.create._has_additions_status_info')
    ...
    <script>
        $('#categorization_id').on('change', function() {
            ...
            $.ajax({
                ...
                $('#categorization_id').select2('destroy');
                $('#category_id').html(data);
                $('#categorization_id').select2({
                    theme: 'bootstrap'
                });
            });
