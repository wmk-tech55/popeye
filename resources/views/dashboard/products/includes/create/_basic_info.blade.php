 ...
 <div class="form-group mb-4 row">
     ...
     <div class="col-sm-10">
         <textarea name="ar_overview" id="ar_overview" class="form-control @error('ar_overview') is-invalid @enderror"
             placeholder="@lang('main.overview')" required>
            {{ old('ar_overview') }}
        </textarea>
         @error('ar_overview')
             <div class="invalid-feedback">
 ...
 <div class="form-group mb-4 row one-option-section">
     ...
     <div class="col-sm-10">
         <input type="number" name="discount_percentage" min="0" max="100"  value="{{ old('discount_percentage',0) }}"
             id="discount_percentage" class="form-control @error('discount_percentage') is-invalid @enderror"
             placeholder="@lang('main.discount_percentage_note')">
