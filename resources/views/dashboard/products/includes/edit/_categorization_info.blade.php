...
<div class="form-group mb-4 row">
    ...
    <div class="col-sm-10">
        ...
        <select name="categorization_id" id="categorizationId"
            class="form-control countries_id select2 @error('categorization_id') is-invalid @enderror"
            ...
            @foreach ($categorizations as $categorization)
                <option value="{{ $categorization->id }}"
                    {{ $categorization->id == old('categorization_id', $product->categorization_id) ? 'selected' : '' }}>
