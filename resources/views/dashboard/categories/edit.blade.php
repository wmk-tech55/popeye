                    ...
                    <div class="card-text">
                        <form action="{{ route('dashboard.categories.update', $category) }}" method="POST"
                            ...
                            <div class="form-group my-4 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="en_name" value="{{ $category->en_name }}" id="en_name"
                            ...
                            <div class="form-group mb-4 row">
                                <label class="col-sm-2 col-form-label" for="ar_name">@lang('main.ar_name')<span
                                        class="required"></span> </label>
                                <div class="col-sm-10">
                                    <input type="text" name="ar_name" value="{{ $category->ar_name }}" id="ar_name"
                            ...
                            <div class="form-group mb-4 row">
                                <label class="col-sm-2 col-form-label" for="categorization_id">@lang('main.store_categorizations')<span
                                        class="required"></span> </label>
                                <div class="col-sm-10">
                                    <select name="categorization_id" id="categorization_id"
                                        ...
                                        @foreach ($categorizations as $categorization)
                                            <option value="{{ $categorization->id }}"
                                                {{ $categorization->id == old('categorization_id', $category->categorization_id) ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-preview thumbnail" data-trigger="fileinput">
                                            <img src="{{ $category->mainMediaUrl('icon') }}"
