...
@section('content')
    ...
    <div class="d-flex flex-column flex-lg-row align-items-center justify-content-between mb-4">
        ...
        <div>
            <a href="{{ route('dashboard.faqs.show', $faq) }}" class="d-sm-inline-block mb-2 btn btn-sm btn-info shadow-sm">
                <i class="fas fa-eye fa-sm text-white-50"></i> 
                @lang('main.show') {{ $faq->question_by_lang }}
            </a>
                    ...
                    <div class="card-text">
                        <form action="{{ route('dashboard.faqs.update', $faq) }}" method="POST">
                            ...
                            <div class="form-group my-4 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="en_question" value="{{ $faq->en_question }}" id="en_question" class="form-control @error('en_question') is-invalid @enderror" placeholder="@lang('main.en_question')" required>
                            ...
                            <div class="form-group mb-4 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="ar_question" value="{{ $faq->ar_question }}" id="ar_question" class="form-control @error('ar_question') is-invalid @enderror" placeholder="@lang('main.ar_question')" required>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-info">@lang('main.edit') @lang('main.faqs')</button>
                                </div>
                            </div>
                        </form>
                    </div>
