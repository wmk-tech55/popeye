...
<div class="form-group mb-4 row">
    ...
    <div class="col-sm-10">
        <textarea name="en_overview" id="en_overview" class="form-control @error('en_overview') is-invalid @enderror" placeholder="@lang('main.en_overview')" required>
            {{ old('en_overview') }}
        </textarea>
        @error('en_overview')
            <div class="invalid-feedback">
...
<div class="form-group mb-4 row">
    ...
    <div class="col-sm-10">
        <textarea name="ar_overview" id="ar_overview" class="form-control @error('ar_overview') is-invalid @enderror" placeholder="@lang('main.ar_overview')" required>
            {{ old('ar_overview') }}
        </textarea>
        @error('ar_overview')
            <div class="invalid-feedback">
