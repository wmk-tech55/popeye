<div class="modal" tabindex="-1" role="dialog" id="createQuickBrand">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('main.add') @lang('main.brands')</h5>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('dashboard.brands.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row  mb-4">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="en_name" value="{{ old('en_name') }}" id="en_name_brand"
                    ...
                    <div class="form-group  row  mb-4">
                        <label class="col-sm-5 col-form-label" for="ar_name">@lang('main.ar_name')<span
                                class="required"></span> </label>
                        <div class="col-sm-6">
                            <input type="text" name="ar_name" value="{{ old('ar_name') }}" id="ar_name_brand"
            ...
            <div class="modal-footer">
                    ...
                    <button type="button" id="quick-brand-add" class="btn btn-info">@lang('main.add') @lang('main.brand')</button>
