...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
        <a href="{{ route('dashboard.categorizations.show', $categorization) }}"
            class="d-sm-inline-block btn btn-sm btn-info shadow-sm">
            <i class="fas fa-eye fa-sm text-white-50"></i>
            @lang('main.show') {{ $categorization->name_by_lang }}
        </a>
        ...
        <div class="card">
            <div class="card-body border-left-info">
                ...
                <div class="card-text">
                    ...
                    <form action="{{ route('dashboard.categorizations.update', $categorization) }}" method="POST"
                        ...
                        <div class="form-group my-4 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="en_name" value="{{ $categorization->en_name }}" id="en_name"
                        ...
                        <div class="form-group mb-4 row">
                            <label class="col-sm-2 col-form-label" for="ar_name">@lang('main.ar_name')<span
                                    class="required"></span> </label>
                            <div class="col-sm-10">
                                <input type="text" name="ar_name" value="{{ $categorization->ar_name }}" id="ar_name"
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-preview thumbnail" data-trigger="fileinput">
                                        <img src="{{ $categorization->mainMediaUrl('icon') }}"
